...
?>
    ...
    <section class="pd-hero-section set-bg" data-setbg="<?php echo get_theme_file_uri()?>/img/footer-bg.jpg">
        <div class="container">
            <div class="row">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="pd-details-text">
                        <div class="pd-desc">
                            <h4>Description</h4>
                            <p>Architecto libero autem velit dignissimos doloribus. Repudiandae nam at quae autem dolores. Tenetur ex quo ex nisi cupiditate temporibus. Magnam saepe dolores iure id. Et odit dolorem sed aut enim. Nobis omnis tempora eum quam commodi veritatis voluptate. Animi modi eligendi omnis quia expedita tecto libero autem velit dignissimos doloribus. Repudiandae nam at quae autem dolores. Tenetur ex quo ex nisi cupiditate temporibus. Magnam saepe dolores iure id. Et odit dolorem sed aut enim. Nobis omnis tempora eum quam commodi veritatis voluptate. Animi modi eligendi omnis quia expedita h</p>
                        </div>
